...
exports.scrapeContactsFromWebsite = scrapeContactsFromWebsite;
const node_fetch_1 = __importDefault(require("node-fetch"));
async function scrapeContactsFromWebsite(website) {
    try {
        ...
        const businessEmails = Array.from(foundEmails).filter(email => !email.includes("noreply") &&
        ...
        const priorityEmails = businessEmails.filter(email => email.includes("contact") || email.includes("info") || email.includes("hello") || email.includes("support"));
        return {
