...
export declare class Scraper {
   ...
   */
    ...
    scrapeLeads(keyword: string, cities: string[], targetLimit: number, existingLeads: Lead[], progressCallback: (count: number) => void, logsCallback: (logs: string, update?: boolean, sdkId?: string) => void, sdks: Record<string, any>): Promise<Lead[]>;
