...
exports.GooglePlacesSDK = exports.ScrapingBeeSDK = void 0;
class ScrapingBeeSDK {
    apiKey;
...
exports.ScrapingBeeSDK = ScrapingBeeSDK;
...
class GooglePlacesSDK {
    ...
    async searchBusinesses(query, location, limit = 10) {
        try {
            ...
            const searchResponse = await fetch(`${this.endpoint}/textsearch/json?` + new URLSearchParams({
            ...
            for (const place of places) {
                try {
                    const detailsResponse = await fetch(`${this.endpoint}/details/json?` + new URLSearchParams({
...
exports.GooglePlacesSDK = GooglePlacesSDK;
